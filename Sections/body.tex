...
\begin{nota}[\idx{$\mu$}, \idx{population mean}]
\end{nota}

\begin{nota}[\idx{$\bar{y}$}, \idx{sample mean}]
    Read ``y bar''.
\end{nota}
...
\begin{nota}[\idx{$\sigma^{2}$}, \idx{population variance}]
\end{nota}
...
\begin{nota}[\idx{$s^{2}$}, \idx{sample variance}]
\end{nota}
...
\begin{nota}[\idx{$\sigma$}, \idx{standard deviation}]
\end{nota}
